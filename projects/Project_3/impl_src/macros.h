...
#define VADDR_PAGENUM(addr) 	((addr) >> 20)   /* TASK 1e: Get the page number from a virtual address. */
#define VADDR_OFFSET(addr)  	(((addr) << 20) >> 20)   /* TASK 1f: Get the page number from a virtual address. (last 12 bits) */
